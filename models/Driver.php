...
class Driver extends Model
{
     ...
     */
    public $table = 'acornassociated_lojistiks_drivers';
    ...
    public $hasOne = [];
    public $hasMany = [
        'lojistiks_transfers_driver' => [\AcornAssociated\Lojistiks\Models\Transfer::class, 'key' => 'driver_id', 'type' => '1fromX']
    ];
    public $hasOneThrough = [];
    public $hasManyThrough = [];
    public $belongsTo = [
        'person' => [\AcornAssociated\Lojistiks\Models\Person::class, 'key' => 'person_id', 'name' => TRUE, 'type' => 'Xto1'],
