...
/**
 * Products Product Category Backend Controller
 */
class ProductsProductCategory extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('AcornAssociated.Lojistiks', 'lojistiks', 'productsproductcategory');
    }
}
